...
module MUL(clk, in_valid, a, b, o, out_valid);
  ...
  reg [63:0] o_reg = 64'h0000000000000000;
  (* src = "verilog/multiplier.sv:34.32-34.42" *)
  wire [63:0] o_reg_next;
  ...
  assign b_reg_next = _04_ ? (* src = "verilog/multiplier.sv:32.38-32.72" *) b : { 1'h0, b_reg[31:1] };
  assign counter_next = busy ? (* src = "verilog/multiplier.sv:33.31-33.54" *) _00_ : 6'h00;
  assign _10_ = b_reg[0] ? (* src = "verilog/multiplier.sv:34.66-34.97" *) _09_ : 64'h0000000000000000;
  assign o_reg_next = busy ? (* src = "verilog/multiplier.sv:34.45-34.98" *) _01_ : 64'h0000000000000000;
  assign o = o_reg;
