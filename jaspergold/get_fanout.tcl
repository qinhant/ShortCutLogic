...
elaborate -top top
get_fanout -transitive in_b_1 
get_fanout -transitive in_b_2
clear -all

# Get fanout for secrets in sodor5_miter_clean.sv
analyze -sva verilog/sodor5_miter_clean.sv +define+ASSUME_ON=1
elaborate -top top
get_fanout -transitive secret_1 
get_fanout -transitive secret_2
clear -all
...
elaborate -top top
get_fanout -transitive B_in_1 
get_fanout -transitive B_in_2
clear -all

# Get fanout for secrets in single_divider_ws_miter.sv
analyze -sva verilog/single_divider_ws_miter.sv +define+ASSUME_ON=1
elaborate -top top
get_fanout -transitive input_b_1 
get_fanout -transitive input_b_2
clear -all
